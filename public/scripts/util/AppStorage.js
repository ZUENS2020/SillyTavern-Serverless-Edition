...
/**
 * Provides access to single-instance browser preference storage.
 */
class AppStorage {
    /**
    ...
    /**
     * Initialize application preference storage.
    ...
    getItem(key) {
        if (!this.#ready) {
            console.warn(`AppStorage not ready (trying to read from ${key})`);
        }
    ...
    setItem(key, value) {
        if (!this.#ready) {
            console.warn(`AppStorage not ready (trying to write to ${key})`);
        }
    ...
    removeItem(key) {
        if (!this.#ready) {
            console.warn(`AppStorage not ready (trying to remove ${key})`);
        }
...
/**
 * Application preference storage instance.
 */
