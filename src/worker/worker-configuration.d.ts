/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: 0432a62cacc2a4c4e5c2bd4e04924de6)
// Runtime types generated with workerd@1.20260820.1 2026-08-28
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	APP_NAME: "SillyTavern Serverless Edition";
	APP_VERSION: "2.0.0-serverless.0";
	APP_ORIGIN: "https://sillytavern.zuens2020.work";
	ACCESS_TEAM_DOMAIN: "https://zuens2020.cloudflareaccess.com";
	ACCESS_AUD: "SET_AFTER_ACCESS_APPLICATION_CREATION";
	AI_GATEWAY_ID: "sillytavern";
	EMBEDDING_MODEL: "@cf/baai/bge-m3";
	EMBEDDING_SCHEMA_VERSION: "1";
	TEST_BYPASS_ACCESS: "false";
	MAX_JSON_BYTES: "1048576";
	MAX_UPLOAD_BYTES: "26214400";
	MAINTENANCE: Workflow<Parameters<import("./index").MaintenanceWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_VERSION" | "APP_ORIGIN" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "AI_GATEWAY_ID" | "EMBEDDING_MODEL" | "EMBEDDING_SCHEMA_VERSION" | "TEST_BYPASS_ACCESS" | "MAX_JSON_BYTES" | "MAX_UPLOAD_BYTES">> {}
}
